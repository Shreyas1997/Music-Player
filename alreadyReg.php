...
<div class="jumbotron text-xs-center">
  <h1 class="display-3 text-center"><i class="fas fa-exclamation-triangle"></i></h1>
  <h1 class="display-3 text-center">Error Occured!</h1>
  <p class="lead text-center"><strong>You have already registered for this event.</strong>
    You cannot register for the same event more than once.
  </p>
  <hr>
  <div class="alert alert-warning text-center" role="alert">
    Please don't click on browser back button. The session will be expired!
  </div>
  <div class="alert alert-warning text-center" role="alert">
    Click on the button provided below.
  </div>
  <p class="lead text-center">
    <a class="btn btn-primary" href="eventPage.php" role="button">Go back to Event Page</a>
  </p>
</div>
</body>
</html>