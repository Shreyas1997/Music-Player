...
<html>
<head>
	<title>Account Don't Exist</title>
...
<div class="jumbotron text-xs-center">
  <h1 class="display-3 text-center"><i class="fas fa-user-slash"></i></h1>
  <h1 class="display-3 text-center">Error Occured!</h1>
  <p class="lead text-center"><strong>Account does not exist.</strong></p>
  <hr>
