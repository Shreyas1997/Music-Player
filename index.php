...
<body style="background-color: #010001;">
	<div class="jumbotron text-center jumbo">
  		<h1 class="display-4" style="background-color: #0000004d"><b>ENVISION 2K19</b></h1>
  		<p class="lead" style="background-color: #0000004d">An Intercollege Fest</p> 
      <img src="img/logoMain.png" alt="Main logo" width="75px" height="100px">
      <h4 class="display-6 lead" style="background-color: #0000004d"><b>Srinivas Institute Of Technology</b></h4>
	</div>
  <div class="container cont1">
 	  <div class="row r1">
      <div class="col-sm-4 col1">
        <br>
    		<h1 class="text-center"><i class="fa fa-question"></i></h1>
    		<br>
      	<p class="text-center">A National level Techno-Cultural fest</p>
    	</div>
    	<div class="col-sm-4 col1">
    		<br>
    		<h1 class="text-center"><i class="fas fa-map-marker-alt"></i></h1>
    		<br>
      	<p class="text-center">Srinivas Institute of Technology <br> Valachil, Mangaluru</p>
    	</div>
    	<div class="col-sm-4">
    		<br>
    		<h1 class="text-center"><i class="fas fa-calendar-alt"></i></i></h1>
    		<br>
      	<p class="text-center">11<sup>th</sup> & 12<sup>th</sup> March 2019 </p>
    	</div>
  	</div>
	</div>
  <!--buttons-->
  <div class="container  cont2">
    <p class="lead text-center" style="color: whitesmoke;">Wanna Participate?</p>
    <button type="button" class="btn btn-info btn-lg bt1" onclick="window.location.href='login.php'">SignIn</button>
    <button type="button" class="btn btn-info btn-lg bt1" onclick="window.location.href='register.php'">SignUp</button>
  </div>
  <!--EVENTS-->
    <div class="jumbotron text-center jumboEve" style="background-image: url('img/bg2.jpg');">
...
<div class="jumbotron jumbotron-fluid">
  <h3 class="text-center display-4">Our Organizers</h3>
  <br>
<div class="card-group">
  <div class="card">
    <img class="card-img-top" src="img/principal.jpg" alt="Dr. Shrinivasa Mayya D.">
    <div class="card-body">
      <h5 class="card-title">Dr. Shrinivasa Mayya D.</h5>
      <p class="card-text">Principal</p>
    </div>
  </div>
  <div class="card">
    <img class="card-img-top" src="img/envCord.jpeg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Mr.Deepak Raj</h5>
      <p class="card-text">Envision Co-ordinator</p>
    </div>
  </div>
  <div class="card">
    <img class="card-img-top" src="img/stuCord.jpeg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Dhananjay Kumar</h5>
      <p class="card-text">Student Co-ordinator</p>
    </div>
  </div>
</div>
</div>
