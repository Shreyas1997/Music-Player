...
<div class="jumbotron text-xs-center">
  ...
  <p class="lead text-center"><strong>You have to be Signed In before enrolling for event.</strong>
  </p>
  ...
  <p class="lead text-center">
    <a class="btn btn-primary" href="index.php" role="button">Continue to Home page</a>
  </p>
</div>
</body>
</html>